 ...
 * Add a vendor.
 *
 * Replaces the "Add New Vendor" dialog that opened over the RFQ management
 * page. A full route makes the form linkable and matches the create screens
...
export default function NewVendorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/rfq-management?tab=vendors");
    } catch (e) {
      const err = e as {
