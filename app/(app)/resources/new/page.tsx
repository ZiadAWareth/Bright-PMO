...
const ResourceCreatePage = () => {
  ...
  const fieldClass = (hasError: boolean) =>
    `${inputClass}${hasError ? " border-danger bg-danger-soft" : ""}`;

  const getFieldErrorClass = (fieldName: string) =>
    fieldClass(missingFields.includes(fieldName));
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Dropdown
                  ...
                  options={[
                  { value: String("labor"), label: "Labor" },
                  { value: String("equipment"), label: "Equipment" },
                  { value: String("material"), label: "Material" },
                ]}
                />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div ref={materialDropdownRef} className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-9 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-bright focus:border-transparent  dark:text-white ${
                  ...
                  {materialDropdownOpen && !inventoryItemsLoading && !inventoryItemsError && (
                    <ul className="absolute z-10 mt-1 w-full max-h-60 overflow-auto rounded-lg border border-line bg-surface shadow-lg py-1">
                ...
                <div>
                  ...
                  <Dropdown
                    ...
                    options={[
                    ...[
                    { value: String("Cairo, Egypt"), label: "Cairo, Egypt" },
                    { value: String("Giza, Egypt"), label: "Giza, Egypt" },
                  ].map((o) => ({ ...o, group: "Egypt" })),
                    ...[
                    { value: String("Muscat, Oman"), label: "Muscat, Oman" },
                    { value: String("Salalah, Oman"), label: "Salalah, Oman" },
                  ].map((o) => ({ ...o, group: "Oman" })),
                  ]}
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className={fieldClass(Boolean(nameDuplicateError) || missingFields.includes("name"))}
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className={fieldClass(Boolean(emailError) || missingFields.includes("email"))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={fieldClass(Boolean(phoneError) || missingFields.includes("phone_number"))}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="flex h-10 w-full items-center rounded-[10px] border border-line bg-surface-2 px-3 text-sm text-muted">
                    {formData.unit || "—"}
                  </p>
                  <p className="text-xs text-muted mt-1">
              ...
              <div>
                ...
                <Dropdown
                  ...
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      availability_status: __v as any,
                    }))}
                  options={[
                  { value: String("available"), label: "In Stock" },
                  { value: String("on_leave"), label: "Low Stock" },
                  { value: String("inactive"), label: "Out of Stock" },
                  { value: String("available"), label: "Available" },
                  { value: String("on_leave"), label: "On Leave" },
                        ...
                        {formData.skills.filter(
                          ...
                          formData.skills
                            ...
                            .map((skill) => (
                              <span
                                key={skill.id}
                                className="px-2 py-1 bg-info-soft text-info rounded-full text-xs"
                              >
                        ...
                        {formData.skills.filter(
                          ...
                          formData.skills
                            ...
                            .map((skill) => (
                              <span
                                key={skill.id}
                                className="px-2 py-1 bg-success-soft text-success rounded-full text-xs"
                              >
                                {skill.name} ({skill.proficiency})
                              </span>
                            ))
    ...
    <>
      ...
      >
        <div className="space-y-6">
          <PageHeader
            title="New Resource"
            subtitle="Add a person, equipment item or material to the resource pool"
            backHref="/resources"
                  ...
                  {missingFields.length > 0 && (
                    <ul className="mt-2 flex flex-wrap gap-1.5">
                      {missingFields.map((field, index) => (
                        <li
                          key={index}
                          className="rounded-full bg-danger/10 px-2.5 py-0.5 text-[12px] font-medium"
                        >
                          {field}
                        </li>
                      ))}
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-surface rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl border border-line">
            ...
            <div className="text-center">
              ...
              {/* Resource Details */}
              <div className="bg-surface-2 rounded-lg p-4 mb-6 text-left space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-success capitalize">
                    {(
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 bg-bright hover:bg-bright-deep text-white px-4 py-2.5 rounded-lg transition-colors font-medium"
                >
                  View All Resources
                </button>
                <button
                  ...
                  className="flex-1 border border-line text-ink-3 hover:bg-surface-2 px-4 py-2.5 rounded-lg transition-colors font-medium"
                >
                  Add Another
                </button>{" "}
              </div>
    ...
    <div className="space-y-6">
          ...
          <div className="space-y-2">
            {skills
              ...
              .map((skill) => (
                <div
                  key={skill.id}
                  className="flex items-center justify-between p-3 bg-info-soft rounded-lg"
                >
          ...
          <div className="space-y-2">
            {skills
              ...
              .map((skill) => (
                <div
                  key={skill.id}
                  className="flex items-center justify-between p-3 bg-success-soft rounded-lg"
                >
                  <div className="flex items-center space-x-3">
                    <span className="font-medium text-ink">
                      {skill.name}
      ...
      <div className="border-2 border-dashed border-line rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          <div>
            <Dropdown
              value={String(newSkillCategory ?? '')}
              onChange={(__v: string) =>
                setNewSkillCategory(__v as "skill" | "language")}
              options={[
              { value: String("skill"), label: "Skill" },
              { value: String("language"), label: "Language" },
            ]}
            />
          </div>
          ...
          <div>
            <Dropdown
              ...
              onChange={(__v: string) => setNewSkillProficiency(__v as any)}
              options={[
              { value: String("beginner"), label: "Beginner" },
              { value: String("intermediate"), label: "Intermediate" },
              { value: String("advanced"), label: "Advanced" },
              { value: String("expert"), label: "Expert" },
            ]}
            />
          </div>
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-bright text-white rounded-md hover:bg-bright-deep disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1"
            >
        ...
        <button
          ...
          className="text-sm text-bright hover:text-bright-deep flex items-center space-x-1 mt-2"
        >
        ...
        {/* Skill Suggestions */}
        {showSuggestions && (
          <div className="mt-4 p-4 bg-surface-2 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-2 gap-2">
              {Object.entries(skillSuggestions).map(([category, skills]) => (
                <div key={category}>
                  <span className="text-xs font-semibold text-ink-3 uppercase mb-1">
                    {category}
                  </span>
                  <div className="flex flex-wrap gap-2">
                    {skills.map((skill) => (
                      <button
                        ...
                        className="px-3 py-1 bg-surface-3 rounded-md text-sm font-medium text-ink-2 hover:bg-surface-3 transition-colors"
                      >
                        {skill}
                      </button>
                    ))}
