                        ...
                        <>
                            ...
                            <div className="mb-6">
                                <FilterBar
                                    ...
                                    searchPlaceholder="Search portfolios by name or description…"
                                    resultLabel={`${filteredPortfolios.length} ${filteredPortfolios.length === 1 ? "portfolio" : "portfolios"}`}
                                    activeCount={
                                        (filters.status ? 1 : 0) +
                                    ...
                                    onClear={() =>
                                        setFilters({ ...filters, status: "" as PortfolioStatus, priority: "" as PortfolioPriority, tag: "" })
                                    }
                                >
                                    <FilterSelect
                                        label="Status"
                                        ...
                                        onChange={(v) =>
                                            setFilters({ ...filters, status: (v === "all" ? "" : v) as PortfolioStatus })
                                        }
                                        options={[
                                    ...
                                    <FilterSelect
                                        ...
                                        onChange={(v) =>
                                            setFilters({ ...filters, priority: (v === "all" ? "" : v) as PortfolioPriority })
                                        }
                                        options={[
                                    ...
                                    <FilterSelect
                                        ...
                                        onChange={(v) => setFilters({ ...filters, tag: v === "all" ? "" : v })}
                                        options={[
                                            { value: "all", label: "All tags" },
                                            ...getAllTags().map((t: string) => ({ value: t, label: t })),
                                        ]}
                                    />
                                </FilterBar>
                            </div>
