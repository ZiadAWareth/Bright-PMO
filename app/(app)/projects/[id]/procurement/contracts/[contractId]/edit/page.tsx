...
/**
 * Edit a contract from a project's procurement page.
 *
 * Replaces the "Edit Contract" dialog.
 */
export default function EditProjectContractPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        const [contractRes, procRes, vendorRes] = await Promise.all([
          axios.get(`/api/contracts/${contractId}`, auth),
        ...
        setProcurementId(String(c.procurement_id ?? ""));
        setVendorId(String(c.vendor_id ?? ""));
            ...
            <FormSection>
              <div className="py-10 text-center">
                ...
                <p className="mt-1 text-[13.5px] text-muted">
                  The contract you are trying to edit could not be found.
                </p>
