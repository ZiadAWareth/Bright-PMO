...
const ProjectCreatePage = () => {
  ...
  /**
   * A form control, plus a danger border when the field is in error. Built on
   * the shared inputClass so an errored control is the standard control with
   * one thing changed, rather than a separately-invented style.
   */
  const fieldClass = (hasError: boolean) =>
    `${inputClass}${hasError ? " border-danger focus:ring-danger/40" : ""}`;

  /** As fieldClass, but for textareas, which must not take inputClass h-10. */
  const areaClass = (hasError: boolean) =>
    `${textareaClass}${hasError ? " border-danger focus:ring-danger/40" : ""}`;
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    {activeView === "admin" && (
                                        <button
                                            ...
                                            className="px-4 py-3 bg-surface-2 text-ink-3 rounded-lg hover:bg-surface-3 transition-colors"
                                        >
                                            Generate
                                        </button>
                                    )}
              ...
              <div>
                ...
                <Dropdown
                  ...
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      priority: __v as "high" | "medium" | "low",
                    }))}
                  options={[
              ...
              <div>
                ...
                <Dropdown
                  value={String(formData.calendarType ?? '')}
                  onChange={(__v: string) => {
                    const newCalendarType = __v as "5-day" | "6-day" | "7-day" | "custom";
                    setFormData((prev) => {
                      const updated = {
                        ...prev,
                  ...
                  options={[
                  { value: String("5-day"), label: "5-Day Week (Fri-Sat Off)" },
                  { value: String("6-day"), label: "6-Day Week (Fri Off)" },
                  { value: String("7-day"), label: "7-Day Week (No Days Off)" },
                  { value: String("custom"), label: "Custom Off Days" },
                ]}
                />
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map((day) => (
                        <label key={day} className="flex cursor-pointer items-center gap-2 rounded-[10px] border border-line px-3 py-2 text-sm transition-colors hover:bg-surface-2">
                          <input
                            type="checkbox"
                            ...
                            className="w-4 h-4 text-bright border-line rounded focus:ring-bright"
                          />
                          <span className="text-sm text-ink-3">{day}</span>
                        </label>
                      ))}
                    </div>
              ...
              <div>
                ...
                <div className="flex min-h-10 w-full items-center rounded-[10px] border border-line bg-surface-2 px-3 text-sm text-muted">
                  {formData.estimatedDuration > 0 ? (
                    ...
                    <span className="text-muted">Enter start date and deadline</span>
                  )}
                </div>
                <p className="mt-1 text-xs text-muted">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className={areaClass(Boolean(fieldErrors.description))}
              ...
              <div>
                ...
                <Dropdown
                  ...
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      type: __v as ProjectType,
                    }))}
                  options={[
                  { value: String(""), label: "Select type" },
                  ...Object.values(ProjectType).map((type) => ({ value: String(type), label: type .replace(/_/g, " ") .replace(/\b\w/g, (l) => l.toUpperCase()) })),
                ]}
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Dropdown
                  value={String(formData.strategicValue ?? '')}
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      strategicValue: __v as
                        | "high"
                        | "medium"
                        | "low",
                    }))}
                  options={[
                  { value: String("low"), label: "Low Strategic Value" },
                  { value: String("medium"), label: "Medium Strategic Value" },
                  { value: String("high"), label: "High Strategic Value" },
                ]}
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Dropdown
                  value={String(formData.portfolio ?? '')}
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      portfolio: parseInt(__v),
                    }))}
                  options={[
                  { value: String(""), label: "Select Portfolio" },
                  ...portfolios.map((portfolio: Portfolio) => ({ value: String(portfolio.portfolio_id), label: portfolio.name })),
                ]}
                />
              </div>
              ...
              <div>
                ...
                <Dropdown
                  value={String(formData.epsLevel ?? '')}
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      epsLevel: parseInt(__v),
                    }))}
                  options={[
                  { value: String(""), label: "Select EPS Level" },
                  ...epsLevels.map((level: EpsLevel) => ({ value: String(level.eps_id), label: level.name })),
                ]}
                />
              </div>
              ...
              <div>
                ...
                <Dropdown
                  ...
                  options={[
                  { value: String(""), label: "Select Methodology" },
                  ...methodologies.map((methodology) => ({ value: String(methodology), label: methodology })),
                ]}
                />
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                {formData.objectives.map((objective, index) => (
                  <div key={index} className="flex items-center space-x-2 mb-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-line rounded-lg text-ink bg-surface focus:outline-none focus:ring-2 focus:ring-bright"
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 text-bright hover:bg-bright-soft rounded-lg transition-colors"
                >
                  <Plus size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative" ref={pmDropdownRef}>
                  ...
                  {showPMSelection && (
                    <div className="absolute top-full left-0 right-0 mt-1 bg-surface border border-line rounded-lg shadow-lg z-10 max-h-80 overflow-hidden flex flex-col">
                          ...
                          <div className="max-h-48 overflow-y-auto">
                            {filteredPmoUsers.map((user: any) => (
                              <button
                                ...
                                className="w-full flex items-center p-3 hover:bg-surface-2 transition-colors text-left"
                              >
                                <UserAvatar
                                  name={personName(user)}
                                  className="mr-3 h-8 w-8 text-sm"
                                />
                          ...
                          {filteredEmployees.map((emp: any) => {
                            ...
                            return (
                              <button
                                ...
                                className="w-full flex items-center p-3 hover:bg-surface-2 transition-colors text-left"
                              >
                                <UserAvatar name={fullName} className="mr-3 h-8 w-8 text-sm" />
                                <div className="flex-1">
                                  <p className="font-medium text-ink">
                                    {fullName}
                                  </p>
              ...
              {/* <div className="flex items-end">
                <div className="w-full">
                  ...
                  <div className="flex min-h-10 items-center gap-2 rounded-[10px] border border-line bg-surface-2 px-3 text-sm text-muted">
            ...
            <div>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-3">
                    ...
                    {formData.teamMembers.length > 0 && (
                      <span className="px-2 py-1 bg-bright-soft text-bright text-xs font-medium rounded-full">
                  ...
                  {/* <button
                    ...
                    className="flex items-center px-4 py-2 bg-bright text-white rounded-lg hover:bg-bright-deep transition-colors"
                  >
                  ...
                  <div className="border border-line rounded-lg p-4 bg-surface-2">
                    ...
                    <div className="mb-4">
                      <input
                        ...
                        className="flex h-10 w-full items-center rounded-[10px] border border-line bg-surface-2 px-3 text-sm text-muted"
                      />
                    </div>
              ...
              <div className="mt-8 space-y-4">
                {formData.teamMembers.map((member, index) => (
                  <div
                    key={member.id}
                    className="border border-line rounded-lg p-4 bg-surface shadow-sm hover:shadow-md transition-all duration-200"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-bright-soft rounded-full flex items-center justify-center">
                          <User size={16} className="text-bright" />
                        </div>
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1 px-2 py-1 text-danger hover:bg-danger-soft rounded-md transition-colors"
                      >
                        <Trash2 size={14} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        {member.responsibility === "Project Manager - Team Lead" ? (
                          ...
                          <div className="flex h-10 w-full items-center justify-between rounded-[10px] border border-line bg-surface-2 px-3 text-sm text-muted">
                            <span>{member.role}</span>
                            <span className="text-xs px-2 py-0.5 bg-info-soft text-info rounded">
                              Auto-assigned
                            </span>
                          </div>
                        ) : (
                          <Dropdown
                            ...
                            { value: String("Developer"), label: "Developer" },
                            { value: String("Designer"), label: "Designer" },
                            { value: String("Business Analyst"), label: "Business Analyst" },
                            { value: String("QA Engineer"), label: "QA Engineer" },
                            { value: String("DevOps Engineer"), label: "DevOps Engineer" },
                            { value: String("Technical Lead"), label: "Technical Lead" },
                            { value: String("Scrum Master"), label: "Scrum Master" },
                            { value: String("Product Owner"), label: "Product Owner" },
                            { value: String("Architect"), label: "Architect" },
                            { value: String("Consultant"), label: "Consultant" },
                            { value: String("Other"), label: "Other" },
                          ]}
                          />
                        )}
                      </div>
                      <div>
                        ...
                        <Dropdown
                          ...
                          options={[
                          { value: String(""), label: "Select department" },
                          { value: String("Engineering"), label: "Engineering" },
                          { value: String("Design"), label: "Design" },
                          { value: String("Product"), label: "Product" },
                          { value: String("Marketing"), label: "Marketing" },
                          { value: String("Sales"), label: "Sales" },
                          { value: String("Operations"), label: "Operations" },
                          { value: String("Finance"), label: "Finance" },
                          { value: String("HR"), label: "Human Resources" },
                          { value: String("IT"), label: "Information Technology" },
                          { value: String("Legal"), label: "Legal" },
                          { value: String("External"), label: "External Consultant" },
                        ]}
                        />
                      </div>
                      <div className="md:col-span-2">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="flex items-center space-x-2">
                          {[member.name, member.email, member.role].filter(
                            ...
                            <>
                              <Clock size={14} className="text-bright" />
                ...
                {/* {formData.teamMembers.length === 0 && (
                  <div className="text-center py-12 border-2 border-dashed border-line rounded-lg bg-surface-2">
                    <Users size={48} className="mx-auto text-faint mb-4" />
                    ...
                    <button
                      ...
                      className="inline-flex items-center space-x-2 px-4 py-2 bg-bright text-white rounded-lg hover:bg-bright-deep transition-colors"
                    >
                      <Plus size={16} />
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Dropdown
                  value={String(formData.reportingFrequency ?? '')}
                  onChange={(__v: string) =>
                    setFormData((prev) => ({
                      ...prev,
                      reportingFrequency: __v,
                    }))}
                  options={[
                  { value: String(""), label: "Select Reporting Frequency" },
                  { value: String("weekly"), label: "Weekly" },
                  { value: String("biweekly"), label: "Bi-weekly" },
                  { value: String("monthly"), label: "Monthly" },
                  { value: String("quarterly"), label: "Quarterly" },
                ]}
                />
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="px-2 py-1 bg-success-soft text-success text-xs rounded-full">
                            Project Level
                          </span>
                        </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="p-2 text-faint hover:text-danger transition-colors rounded-full hover:bg-danger-soft"
                        title="Remove"
                      >
                        <Trash2 size={16} />
                      </button>
      ...
      case "review":
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-surface border border-line rounded-xl p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-muted">{epsName}</p>
                </div>
                <div>
                  <h4 className="font-medium text-ink mb-2">
                    Start Date
                ...
                <div>
                  ...
                  {formData.startDate && formData.mustFinishByDate && (
                    <div className="mt-1">
                      {new Date(formData.mustFinishByDate) > new Date(formData.startDate) ? (
                        <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-success-soft text-success rounded-full">
                          ✓ {formData.estimatedDuration} working days available
                        </span>
                      ) : (
                        <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-danger-soft text-danger rounded-full">
                          ⚠️ Invalid deadline
                        </span>
                      )}
                    </div>
            ...
            {uploadFiles.length > 0 && (
              <div className="bg-surface border border-line rounded-xl p-6">
                <h4 className="font-medium text-ink mb-4 flex items-center space-x-2">
                  <FileText size={20} className="text-bright" />
                ...
                <div className="space-y-2">
                  {uploadFiles.map((file, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-surface-2 rounded-lg">
                      ...
                      <span className="text-xs px-2 py-1 bg-info-soft text-info rounded">
                        Pending upload
                      </span>
                    </div>
                  ))}
        ...
        return (
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-bright-soft rounded-full flex items-center justify-center mx-auto mb-4">
              <Settings size={32} className="text-bright" />
            </div>
    ...
    <ProtectedRoute>
      ...
      >
        <div className="space-y-6">
              ...
              <FormError>
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button
                    ...
                    aria-label="Dismiss"
                    className="shrink-0 rounded p-1 transition-colors hover:bg-danger/10"
                  >
          ...
          <WizardFooter onPrevious={prevStep} previousDisabled={currentStep === 0}>
              ...
              <div className="text-center">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-bright text-white px-4 py-2 rounded-lg hover:bg-bright-deep transition-colors font-medium"
                  >
                    Continue to Setup
                  </button>
                  <button
                    ...
                    className="flex-1 border border-line text-ink-3 px-4 py-2 rounded-lg hover:bg-surface-2 transition-colors font-medium"
                  >
                    View All Projects
                  </button>
                </div>
